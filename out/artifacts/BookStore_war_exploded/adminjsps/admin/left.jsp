...
<head>
    ...
    <script language="javascript">
        var bar1 = new Q6MenuBar("bar1", "Lee网络图书商城");
        ...
        function load() {
            ...
            bar1.add("图书管理", "添加图书", "<c:url value='/AdminBookServlet?method=findAllCategory'/>", "body");
            ...
            bar1.add("订单管理", "未发货订单", "<c:url value='/AdminOrderServlet?method=findByState&state=3'/>", "body");
            bar1.add("订单管理", "未收货订单", "<c:url value='/AdminOrderServlet?method=findByState&state=4'/>", "body");
            bar1.add("订单管理", "已完成订单", "<c:url value='/AdminOrderServlet?method=findByState&state=5'/>", "body");
